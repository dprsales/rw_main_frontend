...
export const CAREER_HOOK = {
  ...
  accent: 'We are looking for closers & leaders of tomorrow.',
}
...
export const CAREER_CATEGORIES = ['Sales', 'Marketing', 'Operations']
...
export const CAREER_ROLES = [
  ...
  },
  {
    ...
    experience: '3–6 years',
    location: 'Hyderabad',
    description: 'Shape the brand narrative and positioning across project launches, campaigns, and the company identity.',
    requirements: ['Experience in brand strategy or brand management', 'Strong storytelling and positioning skills', 'Ability to translate brand thinking into campaigns'],
  },
  {
  ...
  },
  {
    ...
    location: 'Hyderabad',
    description: 'Plan and run digital campaigns across paid, social, and content channels to grow qualified enquiries.',
    requirements: ['Hands-on experience with digital ad platforms', 'Strong analytical skills and campaign reporting', 'Understanding of SEO and social media marketing'],
  },
  {
    ...
    experience: '3–6 years',
    location: 'Hyderabad',
    description: 'Own the content calendar and editorial voice across films, social, email, and launch collateral for premium real estate mandates.',
    requirements: ['Experience planning and running content programmes', 'Sharp writing and editing across long and short form', 'Ability to brief designers, editors, and performance teams'],
  },
  {
  ...
  },
  {
    ...
    experience: '1–4 years',
    location: 'Hyderabad',
    description: 'Cut project films, reels, and brand motion content into polished stories for launches and digital channels.',
    requirements: ['Portfolio of edited video work', 'Strong command of editing and motion tools', 'Good sense of pacing, sound, and colour'],
  },
  {
  ...
  },
  {
    ...
    location: 'Hyderabad',
    description: 'Support day-to-day business operations, assist the sales and marketing teams, coordinate with clients and team members, and learn real estate sales and management.',
    requirements: ['Support day-to-day business operations', 'Assist the sales and marketing teams', 'Coordinate with clients and team members', 'Learn real estate sales and management', 'Real estate exposure preferred, not required', 'Good communication and interpersonal skills', 'High energy and a growth mindset'],
  },
  {
    title: 'Web Developer',
    type: 'FULL-TIME · HYDERABAD',
