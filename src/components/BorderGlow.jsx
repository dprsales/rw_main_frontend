...
/**
 * React Bits' BorderGlow: static border until the cursor nears an edge, then a
 * directional mesh-gradient glow traces it. `animated` (intro sweep) is left off site-wide.
 */
const BorderGlow = ({
  children,
  className = '',
